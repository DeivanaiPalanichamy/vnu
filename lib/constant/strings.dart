...
class Strings {
  ...
  String titleWhatson = "WHAT'S ON";
  String titleViewMore = "VIEW MORE";
  static const String noMoreItem = "NO MORE";
  static const String nowhatson =
      "CHECK AGAIN SOON FOR MORE OF YOUR FAVOURITE CONTENT";
  ...
  static const String memberRegtitle =
      "Please register to access a range of instant discounts and benefits";
  static const String guestRegtitle =
      "Are you already a member? Go back to register with your member info. Hint, register using your member number, DOB and postcode";
  static const String guestNote =
      "You are registering as a guest of Twinstars Group and NOT as a member. Click register to continue as a guest or go back to register with your member info";
}

/*class Controllergetwhatson extends GetxController {
  final giftuser = Strings().obs;
 

  updategift() {
    giftuser.update((value) {
      value!.titleWhatson = 'Deivanai ';
      value.titleViewMore = 'Divya';
    });
  }
...
class Controllergetwhatson extends GetxController {
  ...
  updategift(String a) {
    print("hello deivansai");
    var b = "hi";

    giftuser.update((value) {
      print(a);
      value!.titleWhatson = a;
      value.titleViewMore = 'Divya';
